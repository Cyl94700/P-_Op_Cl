...
from authentication.views import LoginPage, SignupPage, logout_user, profile, subscriptions
...
urlpatterns = [
    ...
    path('profile/<str:user>/abonnements/', subscriptions, name="subscriptions"),
    # review App :
